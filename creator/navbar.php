    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            if (isset($_SESSION["id"]) && !empty($_SESSION["id"])) {
                ...
                echo '<li class="nav-item"><a class="nav-link" href="view_post_messages.php">Post Messages</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="upload_media.php">Media Gallery</a></li>';
